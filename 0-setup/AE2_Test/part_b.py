...
class Gui(Tk):
    ...
    def __init__(self):
        ...
        self.elf_image = PhotoImage(file="//pclures04/home/4mahes86/Documents/Problem Solving Programming/com404/0-setup/AE2_Test/elf.gif")
        self.reindeer_image = PhotoImage(file="//pclures04/home/4mahes86/Documents/Problem Solving Programming/com404/0-setup/AE2_Test/reindeer.gif")
        self.snowman_image = PhotoImage(file="//pclures04/home/4mahes86/Documents/Problem Solving Programming/com404/0-setup/AE2_Test/snowman.gif")
        self.unknown_image = PhotoImage(file="//pclures04/home/4mahes86/Documents/Problem Solving Programming/com404/0-setup/AE2_Test/unknown.gif")
    ...
    def __add_name_entry(self):
        ...
        self.name_entry.bind("<KeyRelease>", self.__name__keyboard_entry)
    ...
    def __add_default_image_label(self):
        self.default_image_label = Label(self.global_frame)
        self.default_image_label.grid(row=3, columnspan=2, sticky=N+S+E+W)
        self.default_image_label.configure(image=self.unknown_image, bg="#f33")


def __NAME_keyboard_entry(self, event):
        response = self.name_entry.get()
        if response == "":
            self.unknown_image_label.configure(image=self._image)
        elif:
    ...
    def __add_post_button(self):
        ...
        self.post_button.grid(row=4, column=0, columnspan=2, sticky=N+S+E+W)
